...
const SITE = [
  ...
  },
  {
    ...
    items: [
      ...
      { f: "pages/field-service-advanced.html", t: "Field Service — Advanced", i: "🛠️", pill: "new",
        k: "field service advanced fsl managed package enhanced scheduling optimization eso appointment bundling bundle policy config restriction propagation complex work dependencies start after finish immediately follow same start same resource multiday crew capacity based contractor shifts shift pattern operating hours time slots territory hierarchy secondary relocation membership gap matrix candidate grade grading work rules count rule extended match visiting hours resource capacity service objectives weighting scheduling policy diagnostic policy arrival window appointment booking service getslots exact appointments slot suppression global in-day resource schedule optimization reshuffle fill in group nearby optimization request pinned appointments scheduling recipes auto dispatch drip feed status transitions status category product item product request product transfer shipment products consumed return order location van stock asset hierarchy warranty maintenance plan maintenance work rule preventive criteria condition based entitlement milestone sla business hours price book rollup time sheet offline priming sync conflict idempotent mobile flows app extensions service report fsl apex api scheduleservice gradeslotsservice appointmentbookingservice oaas optimisation running user salesforce scheduler comparison sharing dispatcher technician troubleshooting" },
